...
describe('TimesheetEntriesController', () => {
  let controller: TimesheetEntriesController;
  ...
  beforeEach(async () => {
    ...
    controller = module.get<TimesheetEntriesController>(TimesheetEntriesController);
  });
